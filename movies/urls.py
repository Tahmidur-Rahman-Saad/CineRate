...
urlpatterns = [
    ...
    path('movie-details/<int:pk>/', views.movieDetails, name='movie-details'),
    path('movie-create/', views.movieCreate, name='movie-create'),
    path('movie-update/<int:pk>/', views.movieUpdate, name='movie-update'),
    path('movie-delete/<int:pk>/', views.movieDelete, name='movie-delete'),
